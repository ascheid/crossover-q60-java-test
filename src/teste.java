...
public class teste {
    ...
    static int[] rearrange(int[] elements) {
    	...
    	/* Sort the vector comparing the amount of 1 in its binary representation if the amount of 1 in its representation is equal,
    	   sort according the decimal weight */ 
